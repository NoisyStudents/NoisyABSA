...
class T5Generator:
    ...
    def get_metrics_in(self, y_true, y_pred):

        # treat as correct anwer when aspects of y_true and y_pred are in inclusion relation
                ...
                for pred_val in pred_list:
                    if pred_val.lower() in gt_val.lower() or gt_val.lower() in pred_val.lower():
                        if pred_val.lower() != gt_val.lower():
                          print(pred_val.lower(), gt_val.lower())
                        tp+=1
                        break
        p = tp/total_pred
        r = tp/total_gt
    ...
    def get_metrics_eq(self, y_true, y_pred):

        # treat as correct answer when  y_true == y_pred
